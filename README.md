...
- [Download](../../releases/latest/download/sketch-color-manager.sketchplugin.zip) the latest release of the plugin
- Un-zip
- Double-click on sketch-color-manager.sketchplugin
